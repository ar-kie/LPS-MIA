...
meta.df$Stimulation <- relevel(as.factor(meta.df.sub$Stimulation),"CTR")
...
#Density plot
#550 x 450
plot.density(meta.df.sub,to.color="Stimulation",to.plot="log10(`Library size`)")

plot.density(meta.df.sub,to.color="Stimulation",to.plot="`Percent. MT`",xlab.title="mtRNA percentage")

plot.density(meta.df.sub,to.color="Stimulation",to.plot="`Percent. ERCC`",xlab.title="ERCC proportion")
...
#Post filter QC (if any samples were removed)
