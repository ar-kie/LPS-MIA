---
title: "LPS MIA accute all samples"
...
subset.df <- gfilt.df[colnames(gfilt.df) %in% rownames(filt.meta[filt.meta$`Accute/chronic` %in% c("Accute"),])]
...
PCA.covar(LPS.sub,covs_forremBatch,data.r=F,type="pearson",heatmap.r=T)
